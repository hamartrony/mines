const createBoard = (rows, columns) => {
  return Array(rows) // Cria array bidimensional, com objetos padrao.
    .fill(0)
    .map((_, row) => {
...
const spreadMines = (board, minesAmount) => {
  ...
  while (minesPlanted < minesAmount) {
    const rowSel = parseInt(Math.random() * rows, 10); // Seleciona aleatorio, numero inteiro, entre o numero de linhas, na base 10.
